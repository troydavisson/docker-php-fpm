...
RUN yum update -y \
    && yum install -y php php-pdo php-mysql php-pgsql php-gd php-pecl-mongo php-mbstring php-mcrypt php-fpm psmisc sqlite php-bcmath php-xml php-pecl-zip git unzip nano \
    && yum clean all \
